...
public class NewCutView extends View
{
	public Object m_obj;
	...
	public NewCutView(Context context)
	{
		super(context);
	}

	public NewCutView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public NewCutView(Context context, AttributeSet attrs, int defStyle)
	{
