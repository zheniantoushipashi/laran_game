...
public class SupernovaFilter implements IImageFilter{
	...
	com.example.mainactivity.RadialDistortionFilter.Point    _pt ;
    double   _radius ;
    int      _count ;
    ...
    public SupernovaFilter(int cr, int radius, int count){
    	 this(new com.example.mainactivity.RadialDistortionFilter.Point(0.0f, 0.0f), cr, radius, count);
    }
   
    public SupernovaFilter(com.example.mainactivity.RadialDistortionFilter.Point pt, int cr, int radius, int count)
    {
        _pt = pt ;
